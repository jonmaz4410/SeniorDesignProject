...
class pkt_xmt(gr.top_block):
    ...
    def __init__(self):
        ...
        self.iio_pluto_sink_0 = iio.pluto_sink(SDR_ID, freq, samp_rate, bandwidth, buffer_size, False, gain, '', True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, './input_csv.csv', True, 0, 0)
...
def main(top_block_cls=pkt_xmt, options=None):
    ...
    try:
        time.sleep(6) #input('Press Enter to quit: ')
    except EOFError:
        pass
    tb.stop()
    tb.wait()
