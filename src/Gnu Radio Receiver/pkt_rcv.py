...
class pkt_rcv(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.buffer_size = buffer_size = 0x1000
        ...
        self.iio_pluto_source_0 = iio.pluto_source(SDR_ID, freq, samp_rate, bandwidth, buffer_size, True, True, True, 'manual', 50, '', True)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/media/jonmaz/dat/complex.dat', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, './output_csv.csv', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_source_0.set_params(self.freq, self.samp_rate, self.bandwidth, True, True, True, 'manual', 50, '', True)
